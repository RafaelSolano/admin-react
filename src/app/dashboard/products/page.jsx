    ...
    <>
                  ...
                  {products?.map((product) => (
                    <tr key={`Product-item-${product.id}`}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        ...
                        <XCircleIcon className= ' hover:text-red-400 flex-shrink-0 h-6 w-6 text-gray-400 cursor-pointer '
                          aria-hidden ="true"
      ...
      <Modal open={open} setOpen={setOpen}>
        ...
        />
         ...
         {/* alert Delete                */}
{/* 
      <Transition.Root show={openAlertDelete} as={Fragment}>
      <Dialog as="div" className="relative z-10" initialFocus={cancelButtonRef} onClose={setOpenAlertDelete}>
        <Transition.Child
          as={Fragment}
                    ...
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-500">
                          Este producto se eliminara de manera permanente
                        </p>
                      </div>
                    </div>
                  </div>
